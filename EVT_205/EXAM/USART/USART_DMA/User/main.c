...
void USARTx_CFG(void)
{
    ...
    // USART3_RX PB11(AF2)
    GPIO_PinAFConfig(GPIOB, GPIO_PinSource11, GPIO_AF2);
...
int main(void)
{
    ...
    while (DMA_GetFlagStatus(DMA1, DMA_FLAG_TC7) == RESET) /* Wait until USART2 TX DMA1 Transfer Complete */
    {
    }
    while (DMA_GetFlagStatus(DMA1, DMA_FLAG_TC6) == RESET) /* Wait until USART2 RX DMA1 Transfer Complete */
    {
    }
    while (DMA_GetFlagStatus(DMA1, DMA_FLAG_TC2) == RESET) /* Wait until USART3 TX DMA1 Transfer Complete */
    {
    }
    while (DMA_GetFlagStatus(DMA1, DMA_FLAG_TC3) == RESET) /* Wait until USART3 RX DMA1 Transfer Complete */
    {
    }
