...
static void GPIO_Config(void)
{
    ...
    // QSPI_SCSN PB0(AF5)
    GPIO_PinAFConfig(GPIOB, GPIO_PinSource0, GPIO_AF5);
    ...
    // QSPI_SIO0 PA2(AF5)
    GPIO_PinAFConfig(GPIOA, GPIO_PinSource2, GPIO_AF5);
    ...
    // QSPI_SIO1 PA3(AF5)
    GPIO_PinAFConfig(GPIOA, GPIO_PinSource3, GPIO_AF5);
    ...
    // QSPI_SIO2 PA0(AF5)
    GPIO_PinAFConfig(GPIOA, GPIO_PinSource0, GPIO_AF5);
    GPIO_InitStructure.GPIO_Pin   = GPIO_Pin_0;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_High;
    GPIO_InitStructure.GPIO_Mode  = GPIO_Mode_AF_PP;
    GPIO_Init(GPIOA, &GPIO_InitStructure);
    ...
    // QSPI_SIO3 PA1(AF5)
    GPIO_PinAFConfig(GPIOA, GPIO_PinSource1, GPIO_AF5);
...
int main(void)
{
    ...
    const uint32_t rd_addr = 0x50000;
