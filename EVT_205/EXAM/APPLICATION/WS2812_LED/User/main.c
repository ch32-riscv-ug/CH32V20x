...
void SPI1_DMA_Init()
{
    ...
    DMA_InitStructure.DMA_Memory0BaseAddr    = (uint32_t)color_buf;
...
void TIM1_Init(void)
{
    ...
    RCC_PB2PeriphClockCmd(RCC_PB2Periph_GPIOA | RCC_PB2Periph_AFIO | RCC_PB2Periph_TIM1, ENABLE);
    GPIO_PinAFConfig(GPIOA, GPIO_PinSource7, GPIO_AF5);
...
{
    if (DMA_GetFlagStatus(DMA1, DMA_FLAG_TC5))
    {
        TIM_Cmd(TIM1, DISABLE);
        DMA_Cmd(TIM_DMA_CH1_CH, DISABLE);
        DMA_ClearFlag(DMA1, DMA_FLAG_TC5);
    }
}
#endif