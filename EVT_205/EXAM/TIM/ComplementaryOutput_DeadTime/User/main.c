...
void TIM1_Dead_Time_Init( u16 arr, u16 psc, u16 ccp )
{
	...
	RCC_PB2PeriphClockCmd(RCC_PB2Periph_AFIO| RCC_PB2Periph_GPIOA |RCC_PB2Periph_GPIOB|RCC_PB2Periph_TIM1, ENABLE);

	GPIO_PinAFConfig(GPIOA,GPIO_PinSource8,GPIO_AF0);//CH1
	GPIO_PinAFConfig(GPIOB,GPIO_PinSource13,GPIO_AF0);//CH1N
...
int main(void)
{
    ...
    printf("SystemClk:%d\r\n", SystemCoreClock);
    printf( "ChipID:%08x\r\n", DBGMCU_GetCHIPID() );
   TIM1_Dead_Time_Init( 100-1, 16000-1, 50 );
