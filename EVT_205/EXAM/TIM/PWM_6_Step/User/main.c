...
void TIM1_PWMOut_Init( u16 arr, u16 psc, u16 ccp )
{
    ...
    GPIO_PinAFConfig(GPIOA, GPIO_PinSource9, GPIO_AF0);
    GPIO_PinAFConfig(GPIOA, GPIO_PinSource10, GPIO_AF0);
    GPIO_PinAFConfig(GPIOB, GPIO_PinSource13, GPIO_AF0);
    GPIO_PinAFConfig(GPIOB, GPIO_PinSource14, GPIO_AF0);
    GPIO_PinAFConfig(GPIOB, GPIO_PinSource15, GPIO_AF0);
...
int main(void)
{
    ...
    TIM1_PWMOut_Init( 100-1, 16000-1, 75 );
