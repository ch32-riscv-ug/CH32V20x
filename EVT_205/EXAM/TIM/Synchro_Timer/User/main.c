...
void TIM_TimSynchroMode1_Init(void)
{
   ...
   TIM_PrescalerConfig(TIM1, 19200 - 1, TIM_PSCReloadMode_Immediate);
 ...
 *
 * @brief   Using TIM1 to start TIM2.
 *
 * @return  none
 */
...
void TIM_TimSynchroMode4_Init(void)
{
    ...
    TIM_PrescalerConfig(TIM1, 19200 - 1, TIM_PSCReloadMode_Immediate);
    TIM_PrescalerConfig(TIM2, 19200 - 1, TIM_PSCReloadMode_Immediate);
