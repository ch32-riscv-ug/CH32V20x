 ...
 * External clock source mode 2: PA0 is used as clock input pin.
 *
*/
...
{
    RCC_PB2PeriphClockCmd(RCC_PB2Periph_TIM1|RCC_PB2Periph_AFIO|RCC_PB2Periph_GPIOA, ENABLE);
	GPIO_PinAFConfig(GPIOA, GPIO_PinSource8, GPIO_AF0);

    TIM_CounterModeConfig(TIM1, TIM_CounterMode_Up);
    TIM_SetAutoreload(TIM1, 0x1B);
    /* GPIOA8 Input as TIM Clock Source */
     TIM_TIxExternalClockConfig(TIM1, TIM_TIxExternalCLK1Source_TI1, TIM_ICPolarity_Falling, 0x00);
    TIM_Cmd(TIM1, ENABLE);
}
...
{
    RCC_PB2PeriphClockCmd(RCC_PB2Periph_TIM1|RCC_PB2Periph_AFIO|RCC_PB2Periph_GPIOA, ENABLE);
	GPIO_PinAFConfig(GPIOA, GPIO_PinSource0, GPIO_AF0);
    ...
    /* GPIOA0 Input as TIM Clock Source */
