...
#define PRINT_EN 0
  ...
  #define dg_log(x,...)
#endif
extern  uint16_t TKY_PollForFilterMode_CS10_Isr(void);
/************************KEY_FIFO_DEFINE******************************/
#define KEY_COUNT       	TKY_MAX_QUEUE_NUM               // Number of keys

#if (TKY_FILTER_MODE == FILTER_MODE_CS10)
#define TKY_PollForFilter()   TKY_PollForFilterMode_CS10_Isr()           //TKY_PollForFilterMode_CS10_Isr() 
#elif (TKY_FILTER_MODE == FILTER_MODE_3)
#define TKY_PollForFilter()   TKY_PollForFilterMode_3()
#elif (TKY_FILTER_MODE == FILTER_MODE_4)
#define TKY_PollForFilter()   TKY_PollForFilterMode_4()
#else
#define TKY_PollForFilter()   TKY_PollForFilterMode_3()
#endif
...
typedef enum
{
    ...
    KEY_12_DOWN,            // * key pressed
    KEY_12_UP,              // * key pop up
    KEY_12_LONG,            // * key long pressed

    KEY_13_DOWN,            // * key pressed
    KEY_13_UP,              // * key pop up
    KEY_13_LONG,            // * key long pressed

    KEY_14_DOWN,            // * key pressed
    KEY_14_UP,              // * key pop up
    KEY_14_LONG,            // * key long pressed

    KEY_15_DOWN,            // * key pressed
    KEY_15_UP,              // * key pop up
    KEY_15_LONG,            // * key long pressed
}KEY_ENUM;

/* Variables used in key FIFO */
#define KEY_FIFO_SIZE   128         //Can be modified to meet the needs of the usage environment and hardware*/
...
#define IBEGIN_TIMING(var) \
    do {                   \
        var = SysTick->CNT \
    } while (0)
#define IEND_TIMING(var)         \
    do {                         \
        var = SysTick->CNT - var \
    } while (0)
