...
#define TKY_BASE_REFRESH_SAMPLE_NUM     			300
...
#define TKY_CHS_INIT                                                 \
        GEN_TKY_CH_INIT (TKY_QUEUE_0, 10,  0xae, 0, 0, 2621, 50, 30), \
        GEN_TKY_CH_INIT (TKY_QUEUE_1, 3,  0xae, 1, 0, 2600, 80, 60), \
        GEN_TKY_CH_INIT (TKY_QUEUE_2, 5,   0xae, 2, 0, 2360, 120, 80), \
        GEN_TKY_CH_INIT (TKY_QUEUE_3, 4,   0xae, 3, 0, 2233, 120, 80), \
        GEN_TKY_CH_INIT (TKY_QUEUE_4,2,  0xae, 4, 0, 2604, 120, 80), \
        GEN_TKY_CH_INIT (TKY_QUEUE_5,11,  0xae, 5, 0, 2604, 120, 80), \
        GEN_TKY_CH_INIT (TKY_QUEUE_6,13,   0xae, 6, 0, 2604, 120, 80), \
        GEN_TKY_CH_INIT (TKY_QUEUE_7,12,   0xae, 7, 0, 2604, 120, 80)
        /* Add new above this */
