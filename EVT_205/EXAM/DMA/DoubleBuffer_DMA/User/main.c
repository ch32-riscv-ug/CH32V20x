...
void TIM1_PWMOut_Init(u16 arr, u16 psc, u16 ccp)
{
    ...
    RCC_PB2PeriphClockCmd(RCC_PB2Periph_AFIO | RCC_PB2Periph_TIM1|RCC_PB2Periph_GPIOA, ENABLE);
...
int main(void)
{
    ...
    TIM1_PWMOut_Init(100 - 1, 19200 - 1, 60);
    TIM1_DMA_Init(DMA1_Channel5, (u32)TIM1_CH1CVR_ADDRESS, (u32)pbuf,(u32)pbuf1, 3);      
    TIM_Cmd(TIM1, ENABLE);
