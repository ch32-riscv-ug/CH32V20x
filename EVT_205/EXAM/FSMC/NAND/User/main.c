...
#include "string.h"
#define  BCR1     (*((volatile unsigned long  *)(0xA0000000)))
#define  BTR1     (*((volatile unsigned long  *)(0xA0000004)))
#define  PCR2     (*((volatile unsigned long  *)(0xA0000060)))
#define  BWTR1     (*((volatile unsigned long  *)(0xA0000104)))
/* Global define */
u8 writebuf[2048];
u8 readbuf[2048];
