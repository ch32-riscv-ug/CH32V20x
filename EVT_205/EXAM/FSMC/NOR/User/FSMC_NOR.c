...
void FSMC_NorFlash_Init(void)
{
    ...
    RCC_PB2PeriphClockCmd(RCC_PB2Periph_GPIOB | RCC_PB2Periph_GPIOD | RCC_PB2Periph_GPIOE|RCC_PB2Periph_AFIO,ENABLE);
    ...
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource8, GPIO_AF7);
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource9, GPIO_AF7);
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource10, GPIO_AF7);
    ...
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource11, GPIO_AF7);
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource12, GPIO_AF7);
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource13, GPIO_AF7);
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource14, GPIO_AF7);
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource15, GPIO_AF7);
    ...
    GPIO_PinAFConfig(GPIOD, GPIO_PinSource13, GPIO_AF7);

    GPIO_InitStructure.GPIO_Pin = GPIO_Pin_3 | GPIO_Pin_4 | GPIO_Pin_5 | GPIO_Pin_6;
    GPIO_InitStructure.GPIO_Mode = GPIO_Mode_AF_PP;
    GPIO_InitStructure.GPIO_Speed = GPIO_Speed_High;
    GPIO_Init(GPIOE, &GPIO_InitStructure);
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource3, GPIO_AF7);
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource4, GPIO_AF7);
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource5, GPIO_AF7);
    GPIO_PinAFConfig(GPIOE, GPIO_PinSource6, GPIO_AF7);
    ...
    GPIO_PinAFConfig(GPIOB, GPIO_PinSource7, GPIO_AF6);
    ...
    readWriteTiming.FSMC_DataLatency = 0x02;
